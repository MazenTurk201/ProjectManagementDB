...
CREATE TABLE Project (
    ...
    INDEX idx_project_budget (Budget)
);
...
CREATE TABLE Milestone (
    ...
    INDEX idx_milestone_completed (Is_Completed),
    INDEX idx_milestone_name (Name)
);
...
CREATE TABLE Member_Task (
    ...
    INDEX idx_member_task_member (Member_ID),
    INDEX idx_member_task_task (Task_ID),
    INDEX idx_member_task_role (Role_In_Task),
    INDEX idx_member_task_primary (Is_Primary_Assignee)
);
...
CREATE TABLE Comment (
    ...
    INDEX idx_comment_timestamp (Timestamp),
